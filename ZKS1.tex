...
\begin{itemize}
	...
	\item Paprastai sistema naudojama turint aiškų tikslą.	\item Apsilankymas banko svetainėje paprastai trunka iki 30 minučių.
...
\begin{enumerate}
	...
	\end{enumerate}
\end{enumerate}
\subsubsectionnonum{Sąskaitos išrašų tikrinimo konceptualus scenarijus}
...
\subsubsectionnonum{Sąskaitos išrašų tikrinimo veiklų charakteristikos}
Veiklos dažnis: Sąskaitos išrašo tikrinimo dažnis varijuoja. Įprasti klientai retai tikrina sąskaitų išrašus. 
\subsubsectionnonum{Sąskaitos išrašų tikrinimo problemos ir tobulinimo galimybės}
...
\begin{itemize}
	...
	\item Pavedimo atlikimas truks ne ilgiau kaip 2 minutes.	\item 95\% klientų iš pirmo karto ras kaip atlikti pavedimą.
\end{itemize}
\pagebreak
